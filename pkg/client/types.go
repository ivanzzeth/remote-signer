...
type CreateHDWalletRequest struct {
	...
	Mnemonic    string `json:"mnemonic,omitempty"`      // Required for import
	EntropyBits int    `json:"entropy_bits,omitempty"`  // For create, default 256
}
...
// SignerInfo represents a signer in API responses.
