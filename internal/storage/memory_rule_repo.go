...
// EnsureSyntheticBudgetRule creates an in-memory placeholder for sim:<signer> budgets.
func (r *MemoryRuleRepository) EnsureSyntheticBudgetRule(ctx context.Context, signerAddress string) error {
	...
	return r.Create(ctx, &types.Rule{
		ID:            ruleID,
