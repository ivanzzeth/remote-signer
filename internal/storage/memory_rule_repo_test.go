...
func TestMemoryRuleRepo_List_EnabledOnly(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "r1", Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "r2", Enabled: false})
	_ = repo.Create(ctx, &types.Rule{ID: "r3", Enabled: true})
...
func TestMemoryRuleRepo_List_ChainTypeFilter(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "r1", ChainType: &evm, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "r2", ChainType: &solana, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "r3", ChainType: nil, Enabled: true}) // nil = applies to all
...
func TestMemoryRuleRepo_List_TypeFilter(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "r1", Type: types.RuleTypeEVMAddressList, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "r2", Type: types.RuleTypeEVMValueLimit, Enabled: true})
...
func TestMemoryRuleRepo_List_Pagination(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		_ = repo.Create(ctx, &types.Rule{ID: types.RuleID(fmt.Sprintf("r%d", i)), Enabled: true})
	}
...
func TestMemoryRuleRepo_ListByChainType(t *testing.T) {
	...
	evm := types.ChainTypeEVM
	_ = repo.Create(ctx, &types.Rule{ID: "r1", ChainType: &evm, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "r2", Enabled: false}) // disabled
...
func TestMemoryRuleRepo_List_SourceFilter(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "rs1", Source: types.RuleSourceConfig, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "rs2", Source: types.RuleSourceAPI, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "rs3", Source: types.RuleSourceConfig, Enabled: true})
...
func TestMemoryRuleRepo_List_ChainIDFilter(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "rc1", ChainID: &chain1, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "rc2", ChainID: &chain137, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "rc3", ChainID: nil, Enabled: true}) // nil = applies to all
...
func TestMemoryRuleRepo_List_APIKeyIDFilter(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "rk1", Owner: key1, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "rk2", Owner: key2, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "rk3", Owner: "", Enabled: true}) // nil = applies to all
...
func TestMemoryRuleRepo_List_SignerAddressFilter(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "rsa1", SignerAddress: &signer1, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "rsa2", SignerAddress: &signer2, Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "rsa3", SignerAddress: nil, Enabled: true}) // nil = applies to all
...
func TestMemoryRuleRepo_List_OffsetBeyondLength(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "ro1", Enabled: true})
	_ = repo.Create(ctx, &types.Rule{ID: "ro2", Enabled: true})
...
func TestMemoryRuleRepo_Count_ReturnsZeroForNoMatch(t *testing.T) {
	...
	_ = repo.Create(ctx, &types.Rule{ID: "rc-nm1", Enabled: false})
