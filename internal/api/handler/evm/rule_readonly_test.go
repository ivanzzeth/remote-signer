...
func (m *mockBudgetRepo) ResetBudget(ctx context.Context, ruleID types.RuleID, unit string, currentPeriodStart time.Time) error {
	if m.resetFn != nil {
		return m.resetFn(ctx, ruleID, unit, currentPeriodStart)
	}
	return nil
}
